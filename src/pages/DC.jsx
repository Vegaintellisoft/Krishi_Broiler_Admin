...
const DC = () => {
    ...
    const { deliveryChallan } = getPermissions();
    ...
    const fetchDCData = async () => {
        setIsLoading(true)
        try {
            const loc_id = user?.role == "Administrator" ? null : location_id;
                ...
                <div className="fixed inset-0 bg-black bg-opacity-40 flex justify-center items-center z-50">
                    ...
                    >
                        <div className="flex justify-between border-b py-2">
                            <h1 className="header text-lg font-semibold">Edit DC</h1>
                            <button
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-x-5 mt-2 gap-y-2">
                            ...
                            <div>
                                <CustomDropdown
                                    ...
                                    onChange={(val) => setFormData(prev => ({ ...prev, rr_no: val }))}
                                    isDisabled={true}
                                />
                            </div>
                            ...
                            <div>
                                <CustomDropdown
                                    ...
                                    value={formData.dispatchFromId}
                                    onChange={(val) => setFormData(prev => ({ ...prev, dispatchFromId: val }))}
                                    isDisabled={true}
                                />
                            </div>
                            <div>
                                <CustomDropdown
                                    ...
                                    value={formData.ship_to__id}
                                    onChange={(val) => setFormData(prev => ({ ...prev, ship_to__id: val }))}
                                    isDisabled={true}
                                />
                            </div>

                            <div>
                                <label className="block text-sm font-medium text-gray-700 mb-2">Truck No</label>
                                <input
                                    type="text"
                                    name="truck_no"
                        ...
                        <div className="flex justify-between gap-24 mt-8 mb-2">
                            <button
                                type="button"
                                onClick={closeModal}
