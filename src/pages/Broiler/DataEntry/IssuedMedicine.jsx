...
const IssuedMedicine = () => {
    ...
    const fetchData = async () => {
        ...
        setTimeout(() => {
            setData([
                { id: 1, date: '2025-10-24', plant: 'Chennai Unit 1', farmer: 'FARM-001 | Krishnan', batchNo: 'B-2025-01', birdStock: 5000, age: 12, material: 'Antibiotic A', transferQty: 10, storageLoc: '0001' },
                { id: 2, date: '2025-10-25', plant: 'Chennai Unit 1', farmer: 'FARM-002 | Balaji', batchNo: 'B-2025-05', birdStock: 4500, age: 8, material: 'Vitamin Supplement', transferQty: 5, storageLoc: '0001' },
            ]);
            setIsLoading(false);
        }, 500);
    };
