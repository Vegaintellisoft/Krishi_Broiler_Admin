...
const BroilerUsers = () => {
    ...
    const filteredData = data.filter((item) => {
        return (
            ...
            item?.password.toString().toLowerCase().includes(searchQuery.toLowerCase()) ||
            item?.mobile.toString().toLowerCase().includes(searchQuery.toLowerCase()) ||
            item?.status.toString().toLowerCase().includes(searchQuery.toLowerCase()) ||
            item?.role.toString().toLowerCase().includes(searchQuery.toLowerCase()) ||
